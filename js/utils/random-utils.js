...
static getRandomLevel(lines, columns) {
    ...
    // --- الإضافة الجديدة: توليد مكانين للجهاز ---
    let devices = RandomUtils.getRandomElements(positions, 2);
    positions = ArrayUtils.removeByValues(positions, devices);
    // ------------------------------------------

    return { holes, wumpus, golds, devices }; // أضفنا devices هنا
}
}